...
const NORMAL_BUTTON_COLOR: Color = Color::rgba(0.2, 0.2, 0.2, 0.5);
const ACTIVE_BUTTON_COLOR: Color = Color::PURPLE;
const LIVE_COLOR: Color = Color::rgba(0.4, 0.4, 0.4, 0.5);
const DEAD_COLOR: Color = Color::rgba(0.3, 0.3, 0.3, 0.5);
const EXTENT_COLOR: Color = Color::rgba(0.3, 0.3, 0.3, 0.5);
